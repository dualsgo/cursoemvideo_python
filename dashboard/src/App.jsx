        ...
        <div className="flex h-screen bg-[#0a0a0c] overflow-hidden">
            ...
            <div className="w-64 border-r border-slate-800 bg-[#0e0e11] p-6 flex flex-col gap-6">
                ...
                <nav className="flex-1 flex flex-col gap-2">
                    ...
                    <SidebarItem icon={Code} label="Sandbox" active={activeTab === 'Sandbox'} onClick={() => setActiveTab('Sandbox')} />
                ...
                <div className="max-w-6xl mx-auto relative z-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <div className="md:col-span-2">
                            <div className="bg-[#0e0e11] rounded-3xl border border-slate-800 overflow-hidden">
                        ...
                        <div className="space-y-6">
                            <div className="bg-slate-900/40 backdrop-blur-md border border-slate-800 p-6 rounded-3xl">
                                ...
                                <div className="space-y-4">
                                    {[
                                        ...
                                        <div key={i} className="flex items-center gap-4 bg-white/5 p-3 rounded-xl border border-white/5 hover:border-white/10 transition-colors">
                            ...
                            <div className="bg-gradient-to-br from-blue-600/20 to-indigo-600/20 border border-blue-500/30 p-8 rounded-3xl relative overflow-hidden group cursor-pointer shadow-xl shadow-blue-500/10">
                                ...
                                <motion.button
                                    whileTap={{ scale: 0.95 }}
                                    className="bg-white text-blue-600 px-6 py-2.5 rounded-2xl text-sm font-bold shadow-lg shadow-white/10 group-hover:shadow-white/20 transition-all flex items-center gap-2"
                                >
                                    Continuar
